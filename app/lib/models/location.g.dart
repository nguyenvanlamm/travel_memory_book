...
Location _locationDeserialize(
  ...
  final object = Location(
    ...
    tripId: reader.readLong(offsets[5]),
  );
  object.id = id;
  return object;
}
...
extension LocationQueryWhereSort on QueryBuilder<Location, Location, QWhere> {
  ...
  QueryBuilder<Location, Location, QAfterWhere> anyTripId() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationQueryWhere on QueryBuilder<Location, Location, QWhereClause> {
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> tripIdEqualTo(
      int tripId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> tripIdNotEqualTo(
      int tripId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> tripIdGreaterThan(
    int tripId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> tripIdLessThan(
    int tripId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> tripIdBetween(
    int lowerTripId,
    int upperTripId, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension LocationQueryFilter
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> descriptionIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> hasCoordinatesEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> tripIdEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'tripId',
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> tripIdGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> tripIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> tripIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension LocationQuerySortBy on QueryBuilder<Location, Location, QSortBy> {
  ...
  QueryBuilder<Location, Location, QAfterSortBy> sortByHasCoordinates() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasCoordinates', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> sortByHasCoordinatesDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterSortBy> sortByTripId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tripId', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> sortByTripIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationQuerySortThenBy
  ...
  QueryBuilder<Location, Location, QAfterSortBy> thenByHasCoordinates() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasCoordinates', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> thenByHasCoordinatesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasCoordinates', Sort.desc);
    });
  }
  ...
  QueryBuilder<Location, Location, QAfterSortBy> thenByTripId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tripId', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> thenByTripIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tripId', Sort.desc);
    });
  }
...
extension LocationQueryWhereDistinct
  ...
  QueryBuilder<Location, Location, QDistinct> distinctByHasCoordinates() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QDistinct> distinctByTripId() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationQueryProperty
  ...
  QueryBuilder<Location, bool, QQueryOperations> hasCoordinatesProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, int, QQueryOperations> tripIdProperty() {
    return QueryBuilder.apply(this, (query) {
